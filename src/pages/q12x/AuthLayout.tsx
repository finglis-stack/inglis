    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      >
        <div className="h-full w-full bg-black/30 flex flex-col justify-end p-12 text-white">
          <h3 className="text-3xl font-bold">Gérez vos transactions. Simplement.</h3>
          <p className="mt-2 text-lg text-gray-200">Acceptez les paiements Inglis Dominium et suivez vos revenus en temps réel.</p>
        </div>
      </div>
    </div>
  );
